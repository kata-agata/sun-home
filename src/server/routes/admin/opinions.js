...
router.get('/newOpinion', (res,req)=>{
  res.render('partials/admin/newOpinion', { opinion: new Opinion()})
});

// router.post('/newOpinion', async (res,req, next)=> {
...
//       console.log(opinion);
//       res.redirect(`/testapp/adminPanel/opinions/${opinon._id}`);
//     } catch(e){
//       console.log(e);
